...
// Fetch book price
$book_result = $conn->query("SELECT price, title FROM books WHERE id = " . $transaction["book_id"]);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strtotime($return_date) <= strtotime($due_date)) {
        ...
        $status = "Overdue";
        $days_late = ceil((strtotime($return_date) - strtotime($due_date)) / (60 * 60 * 24));
        $fine = round($days_late * ($book_price * 0.05), 2);
    }
            ...
            <div class="transaction-info mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 info-item">
                        ...
                        <small class="text-muted">Late returns will incur a 5% daily fine based on book price</small>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function toggleSidebar() {
            ...
            if (window.innerWidth <= 768) {
                ...
                mainContent.style.marginLeft = sidebar.classList.contains('hidden') ? '0' : '270px';
            } else {
                sidebar.classList.toggle('collapsed');
                mainContent.style.marginLeft = sidebar.classList.contains('collapsed') ? '60px' : '270px';
            }
        }
    </script>
</body>
